...
${OBJECTDIR}/_ext/968701377/file.o: ../../kernel/fs/file.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -I../../include -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/968701377/file.o ../../kernel/fs/file.c

${OBJECTDIR}/_ext/968701377/vfs.o: ../../kernel/fs/vfs.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/968701377
	${RM} $@.d
	$(COMPILE.c) -g -I../../include -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/968701377/vfs.o ../../kernel/fs/vfs.c

${OBJECTDIR}/_ext/1109276195/mempool.o: ../../kernel/mempool.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1109276195
	${RM} $@.d
	$(COMPILE.c) -g -I../../include -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1109276195/mempool.o ../../kernel/mempool.c

${OBJECTDIR}/_ext/35041009/membase.o: ../../kernel/std/membase.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/35041009
	${RM} $@.d
	$(COMPILE.c) -g -I../../include -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/35041009/membase.o ../../kernel/std/membase.c

${OBJECTDIR}/_ext/35041009/strings.o: ../../kernel/std/strings.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/35041009
	${RM} $@.d
	$(COMPILE.c) -g -I../../include -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/35041009/strings.o ../../kernel/std/strings.c

${OBJECTDIR}/_ext/683473409/list.o: ../../kernel/utils/list.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/683473409
	${RM} $@.d
	$(COMPILE.c) -g -I../../include -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/683473409/list.o ../../kernel/utils/list.c

${OBJECTDIR}/_ext/683473409/tree.o: ../../kernel/utils/tree.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/683473409
	${RM} $@.d
	$(COMPILE.c) -g -I../../include -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/683473409/tree.o ../../kernel/utils/tree.c

${OBJECTDIR}/kerror_mocked.o: kerror_mocked.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -I../../include -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/kerror_mocked.o kerror_mocked.c

${OBJECTDIR}/kmalloc_mocked.o: kmalloc_mocked.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -I../../include -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/kmalloc_mocked.o kmalloc_mocked.c

${OBJECTDIR}/kmalloc_test.o: kmalloc_test.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -I../../include -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/kmalloc_test.o kmalloc_test.c

${OBJECTDIR}/main.o: main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -I../../include -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.c

${OBJECTDIR}/print_mocked.o: print_mocked.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -I../../include -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/print_mocked.o print_mocked.c

${OBJECTDIR}/vfs_test.o: vfs_test.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -I../../include -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/vfs_test.o vfs_test.c
